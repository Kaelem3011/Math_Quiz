...
class Start:
    def __init__(self, error=""):
        ...
        # Heading label
        self.heading_label = Label(self.start_frame, font='arial 15', text="Math Quiz")
        ...
        # Play button 
        self.play_button = Button(self.buttons_frame, font='arial 12 bold', text="Play", bg='yellow', padx=10, command=lambda:Start.error_checking(self))
