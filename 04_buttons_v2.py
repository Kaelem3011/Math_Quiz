...
class Start:
    def __init__(self):
        ...
        # plus button
        self.plus_button = Button(self.buttons_1_frame, text="+", pady=5, padx=10)
        self.plus_button.grid(row=0, column=0, padx=5)

        # minus button
        self.minus_button = Button(self.buttons_1_frame, text="−", pady=5, padx=10)
        self.minus_button.grid(row=0, column=1, padx=5)

        # times button
        self.times_button = Button(self.buttons_2_frame, text="×", pady=5, padx=10)
        self.times_button.grid(row=0, column=0, padx=5)

        # divide button
        self.divide_button = Button(self.buttons_2_frame, text="÷", pady=5, padx=10)
        self.divide_button.grid(row=0, column=1, padx=5)

        # Quit Button
        self.quit_button = Button(self.buttons_3_frame, text="Quit", command=self.to_quit, padx=5, pady=5)
        self.quit_button.grid(row=1, column=1, padx=5)

        # Help Button
        self.help_button = Button(self.buttons_3_frame, text='help', command=lambda:Help(), padx=15, pady=5)
