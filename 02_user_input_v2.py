...
class Start:
    def __init__(self):
        ...
        self.enter_button = Button(self.start_frame, font="Arial 14 bold",
                                       text="enter", command=self.error_check)
        self.enter_button.grid(row=3, column=0)
    ...
    def error_check(self):
        ...
        try:
            ...
            has_errors = "yes"
            error_feedback = "Only integers, thanks"
